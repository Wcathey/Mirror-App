...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('hex_color_code', sa.String(length=6), nullable=False),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE lipsticks SET SCHEMA {SCHEMA};")
    # ### end Alembic commands ###
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE eyeshadows SET SCHEMA {SCHEMA};")
    # ### end Alembic commands ###
